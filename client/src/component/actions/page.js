...
import {ADD_PAGE, PAGE_ERROR, CLEAR_PAGE_DATA, REMOVE_MODAL, GET_PAGE,SORT_PAGE} from './type'
import uuid from 'uuid'
import {setAlert} from './alert'

export const sortPage = (url, ids) => async dispatch => {
  ...
  try {
    ...
    const res = await axios.post(url, ids, config)
    console.log('res sortpage', res)
    dispatch({
        type:SORT_PAGE,
        payload:res.data
    })
